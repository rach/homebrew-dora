class Dora < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/rach/dora/releases/download/v0.3.1/dora-fs-v0.3.1-macos-arm64.tar.gz"
      sha256 "b7548193d1e8b5aa98a38420ad2ad332f8fd708d69d490f66693f8df323e7285"
    ...
    on_intel do
      odie <<~EOS
        ...
        Build from source instead:
          cargo install --git https://github.com/rach/dora --tag v0.3.1
      EOS
    end
  end
